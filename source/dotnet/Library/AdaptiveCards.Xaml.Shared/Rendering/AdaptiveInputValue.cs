...
namespace AdaptiveCards.Rendering.Wpf
{
    ...
    {
        public AdaptiveInputValue(AdaptiveInput input, FrameworkElement renderedInput)
        {
            InputElement = input;
        ...
        public AdaptiveInputValue(AdaptiveInput input, FrameworkElement renderedInput, FrameworkElement visualElementForAccessibility)
        {
            InputElement = input;
            RenderedInputElement = renderedInput;
        ...
        public FrameworkElement RenderedInputElement { get; set; }

        public TextBlock ErrorMessage { private get; set; }

        public FrameworkElement VisualElementForAccessibility { get; set; }
    }
    ...
    {
        public AdaptiveInputValueNonEmptyValidation(AdaptiveInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }

        public AdaptiveInputValueNonEmptyValidation(AdaptiveInput input, FrameworkElement renderedInput, FrameworkElement visualElementForAccessibility) :
    ...
    {
        public AdaptiveTextBoxInputValue(AdaptiveInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }
...
#elif XAMARIN
                VisualErrorCue.BorderColor = Color.Transparent;
#endif
...
#elif XAMARIN
                //TODO: Red???
                VisualErrorCue.BorderColor = Color.Red;
#endif
            }
        }
...
#elif XAMARIN
        public Frame VisualErrorCue { private get; set; }
#endif
    }

    public class AdaptiveTextInputValue : AdaptiveTextBoxInputValue
    {
        public AdaptiveTextInputValue(AdaptiveTextInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }
    ...
    {
        public AdaptiveNumberInputValue(AdaptiveNumberInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }
    ...
    {
        public AdaptiveDateInputValue(AdaptiveDateInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }
    ...
    {
        public AdaptiveTimeInputValue(AdaptiveTimeInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }
    ...
    public class AdaptiveChoiceSetInputValue : AdaptiveInputValueNonEmptyValidation
    {
        ...
        public AdaptiveChoiceSetInputValue(AdaptiveChoiceSetInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }

        public AdaptiveChoiceSetInputValue(AdaptiveChoiceSetInput inputElement, FrameworkElement renderedElement, FrameworkElement uIElement) : base(inputElement, renderedElement, uIElement) { }
    ...
    {
        public AdaptiveToggleInputValue(AdaptiveToggleInput inputElement, FrameworkElement renderedElement) : base(inputElement, renderedElement) { }
